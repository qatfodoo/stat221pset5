...
\begingroup
\centering
\includegraphics[scale=0.60]{./img/ODpair_rout1.png}\captionof{figure}{Mean Traffic estimates $\hat{\lambda_t}$ for all OD pairs, reproducing figure 5 of the paper.}
\endgroup

\begingroup
\centering
\includegraphics[scale=0.45]{./img/link_load.png}\captionof{figure}{Estimated and observed link loads (marginal plots on figure 5 of the paper). We observe that we underestimate the traffic at pick times.}
\endgroup

\begingroup
\centering
\includegraphics[scale=0.35]{./img/total_linkload.png}\captionof{figure}{Total estimated and observed link loads (top rightmarginal plots on figure 5 of the paper).}
\endgroup
